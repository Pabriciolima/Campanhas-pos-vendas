                                    ...
                                    return `
                                      <tr>
                                        ...
                                        <td>
                                          ...
                                          <button
                                            type="button"
                                            class="crm-mini-button delete"
                                            data-crm-excluir-participante="${escapar(participante.id)}"
                                          >
                                            Excluir
                                          </button>
                                        </td>
                ...
                $("#crmFormParticipante", modal)
                  .addEventListener(
                    ...
                    async evento => {
                      ...
                      const novo = {
                        id: participante?.id || idUnico(),
                        nome: texto(formData.get("nome")),
                        funcao: texto(formData.get("funcao")),
                        nivel: texto(formData.get("nivel")),
                        marca: texto(formData.get("marca")),
                        dn: texto(formData.get("dn")),
                        filial: texto(formData.get("filial")),
                      ...
                      mostrarToast(
                        participante
                          ? "Participante alterado e sincronizado."
                          : "Participante adicionado e sincronizado.",
                        "ok"
                      );
                    }
                  );
                      ...
                      async () => {
                        const participante =
                          estado.participantes.find(
                            item =>
                              item.id ===
                              botao.dataset.crmExcluirParticipante
                          );
                        ...
                        if (
                          !window.confirm(
                            `Excluir definitivamente "${participante.nome}" da base do CRM?\n\nA exclusão será refletida para todos os usuários.`
                          )
                        ) {
                          return;
                        }
                        ...
                        mostrarToast(
                          "Participante excluído e sincronizado.",
                          "ok"
                        );
                      }
                    );
